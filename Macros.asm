...
zonewarning:	macro loc,elementsize
	._end:
		...
		warning 1,"Size of \loc ($%h) does not match ZoneCount ($\#ZoneCount).",(._end-loc)/elementsize
		endif
		endm
...
zonewarningnoending:	macro loc,elementsize
	._end:
		...
		warning 1,"Size of \loc ($%h) does not match ZoneCount (minus ending) ($\#ZoneCount-1).",(._end-loc)/elementsize
		endif
		endm
